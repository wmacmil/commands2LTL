...
/* package toyGrammar-0.1.0.0 */
#ifndef VERSION_toyGrammar
#define VERSION_toyGrammar "0.1.0.0"
#endif /* VERSION_toyGrammar */
#ifndef MIN_VERSION_toyGrammar
#define MIN_VERSION_toyGrammar(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_toyGrammar */
...
#define CURRENT_COMPONENT_ID "toyGrammar-0.1.0.0-inplace-toyGrammar"
